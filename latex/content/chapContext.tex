...
\begin{itemize}
    ...
    Die Kernfunktionalität basiert auf den von WordPress bereitgestellten APIs. %(WP\_List\_Table API, Enqueue API, AJAX API, Plugin Activation API, Template Include API, Mail API, Cron API).
...
\begin{itemize}
    ...
    Für den Build-Prozess kommt ein Tailwind-\gls{cli}-Workflow zum Einsatz, gesteuert über npm-Skripte. Grunt unterstützt Aufgaben wie Internationalisierung und die Generierung von Readme-Dateien. Composer, PHP CodeSniffer (inklusive WPCS und PHPCompatibility) sowie PHPUnit sorgen für Codequalität.
