...
%TODO: QUELLEN CHECKEN UND PRÜFEN: https://developer.wordpress.org/block-editor/ DIE HIER HINTERLEGEN
\\
\\
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{block-structure} % füllt gesamte Textbreite
    \caption{Dateistruktur eines WordPress-Blocks \cite{wordpress2023}}
    \label{fig:block-structure}
\end{figure}
%TODO: Quelle in den Anhang ballern
...
Diese Inhalte sind serialisierbar in \gls{html} und werden im Block HTML gespeichert und so auch in der Datenbank als post\_content abgelegt.

%TODO: Listing tauschen gegen bild
