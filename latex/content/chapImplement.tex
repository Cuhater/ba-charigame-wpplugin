...
Die Code-Validierung erfolgt über die \textt{validate\_key()} Methode, die in der Datenbanktabelle \textt{charigame\_game\_data} nach dem entsprechenden game\_code sucht.
