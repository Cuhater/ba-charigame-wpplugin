...
\newglossaryentry{wdr}{
	...
	description={Ein online Handbuch, das Entwicklungsthemen in Wordpress abdeckt. Es wird kontinuierlich weiterentwickelt und gibt Entwicklern Definitionen, Coding Standards, Wordpress Core Ressources, Block Editor Ressources, gängige APIs, Beispiele und Tutorials and die Hand}
}
\newglossaryentry{dog}{
	name={Hund},
