(function ($, $window, $document, undefined) {
	...
	function getValues(handlePosition, handleDimensions, pickerPoints, options) {
		...
		// Ausgleich der Gesamtsumme auf 100
		// if (totalSum !== 100) {
		// 	var difference = 100 - totalSum;
		// 	var adjustment = difference / 3;
		// 	for (var cornerType in values) {
		// 		// Runden jedes Werts auf die nächste ganze Zahl
		// 		values[cornerType] = Math.round(values[cornerType] + adjustment);
		// 	}
		// }
